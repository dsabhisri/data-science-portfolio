...
st.set_page_config(
    page_title="Domain Knowledge Chatbot - DSC680",
    page_icon="🤖",
    layout="centered"
)

# --- Project Header ---
# Display project title, subtitle, author, and course information at the top of the page
st.title("Domain Knowledge Chatbot")
st.subheader("A Generative AI Fine-Tuning Project")
st.markdown("**Abhishek Srivastava**")
st.markdown("DSC680 | Week 10")
# Add a horizontal line to visually separate the header from the rest of the app
st.markdown("---")
...
if model is None:
    st.error("Fine-tuned model not found at `./gpt2_finetuned_model/`. Please run the training script first.")
    st.stop()
